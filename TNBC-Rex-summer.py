...
def unidentified_qc(fastq_dir):
	...
	adapter_csv = "/home/summer/Documents/adapterParse/RNAseq_index_list.csv"
...
def run_samples_through_ref_set(file):
	...
	sp.call([
		...
		script,
		file])
	print('rpkm_merge_results file with ref_set+lean results is located in ref_set_testing/tables')

if __name__ == '__main__':

	n_proc = str(multiprocessing.cpu_count())
	
	index_path = '/media/summer/ExtraDrive1/Bioinf_tools/STARIndex'
	star_path  = '/media/summer/ExtraDrive1/Bioinf_tools/STAR/source/STAR'
	gtf_path   = '/media/summer/ExtraDrive1/Bioinf_tools/STARIndex/genes.gtf'
